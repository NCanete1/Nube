    ...
    public void Menu() {
        ...
        ActionListener registrar = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (nombre.getText().isEmpty() || rut.getText().isEmpty() || direccion.getText().isEmpty()
                        || correo.getText().isEmpty() || telefono.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(null, "Favor de llenar los campos vacios");
                } else {
                    automotora.añadirCliente(rut.getText(), nombre.getText(), direccion.getText(), correo.getText(),
